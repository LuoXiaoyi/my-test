...
/**
 * @author xiluo
 * @createTime 2019/1/20 00:13
 **/
public class TimeRecorderTransformer implements ClassFileTransformer {
    ...
    public byte[] transform(ClassLoader loader,
        ...
        System.out.println(Thread.currentThread().getName() + "-" + this.getClass() + " transform class: " + className);
        return null;
    }
}
