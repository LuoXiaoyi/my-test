...
/**
 * @author xiaoyiluo
 * @createTime 2018/11/21 22:14
 **/
public class RLocalCachedMapTest {
    ...
    private static void get() {
        RLocalCachedMap<String, Set<String>> nameMap =
                RedisClientManager.redission().getLocalCachedMap("abc", options);
        Set<String> poolNames = nameMap.get("123456");
        if (poolNames != null) {
            for (String name : poolNames) {
                System.out.println(name);
            }
        }
        poolNames.add("hello3");
    }

    private static void save() {
        Set<String> poolNameSet = new HashSet<>();
        poolNameSet.add("hello");
        poolNameSet.add("hello1");
        poolNameSet.add("hello2");
        ...
        poolNames.addAll(poolNameSet);
        nameMap.put("123456", poolNames);
    }

    private static final LocalCachedMapOptions options;
